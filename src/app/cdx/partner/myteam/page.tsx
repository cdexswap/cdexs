          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-5xl mx-auto">
            <div className="text-center">
              <div className="bg-white rounded-full p-4 w-28 h-28 mx-auto mb-6 flex items-center justify-center">
                <Image src="/referral-step1-blue.svg" alt="Step 1" width={60} height={60} unoptimized />
              </div>
            ...
            <div className="text-center">
              <div className="bg-white rounded-full p-4 w-28 h-28 mx-auto mb-6 flex items-center justify-center">
                <Image src="/referral-step2-blue.svg" alt="Step 2" width={60} height={60} unoptimized />
              </div>
            ...
            <div className="text-center">
              <div className="bg-white rounded-full p-4 w-28 h-28 mx-auto mb-6 flex items-center justify-center">
                <Image src="/referral-step3-blue.svg" alt="Step 3" width={60} height={60} unoptimized />
              </div>
        ...
        <div className="bg-gray-900/50 backdrop-blur-lg border border-gray-800 rounded-lg p-6 mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <Image src="/money-bag.svg" alt="Earnings" width={48} height={48} unoptimized />
              <div className="ml-4">
            ...
            <div className="flex items-center">
              <Image src="/users.svg" alt="Friends" width={48} height={48} unoptimized />
              <div className="ml-4">
                <h2 className="text-2xl font-bold text-blue-600">
                ...
                <>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex gap-4">
                      ...
                      >
                        <Image src="/twitter.svg" alt="Twitter" width={24} height={24} unoptimized />
                      </button>
                      <button
                        onClick={shareOnLine}
                        disabled={!referralLink}
                        className={`p-2 transition-opacity ${!referralLink ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-80'}`}
                      >
                        <Image src="/line.svg" alt="Line" width={24} height={24} unoptimized />
                      </button>
                      <button
                        ...
                        className={`p-2 transition-opacity ${!referralLink ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-80'}`}
                      >
                        <Image src="/facebook.svg" alt="Facebook" width={24} height={24} unoptimized />
                      </button>
                    </div>
                  </div>
                </>
